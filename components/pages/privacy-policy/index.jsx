...
const Health = () => {
  return (
    <div>
        ...
        line1="This Application collects some Personal Data from its Users."
        line2="Learn how we collect, use, and protect your information."
      ...
      <div className="col-lg-10">
        ...
        <div className="mb-4">
          ...
          <p className=" mt-4">
            ...
            Data without consequences to the availability or the functioning of the Service.<br />
        ...
        <div className="mb-4">
          ...
          <p className="">
            ...
            to check this page often, referring to the date of the last modification listed at the bottom.<br /><br />
        ...
        <div className="mb-4">
          ...
          <p className="">
            ...
            User, the various time details per visit (e.g., the time spent on each page within the Application) and
            the details about the path followed within the Application with special reference to the sequence of
